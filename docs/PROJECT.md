...
| Key | Value |
|-----|-------|
| Repository | `git@github.com:zheli/agent-skills.git` |

## Current Status

Tracking has been bootstrapped for skill documentation improvements.
...
1. Find the next available ID by checking the table above and open GitHub PRs.
